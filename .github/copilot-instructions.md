# Copilot Instructions for BugRadar
BugRadar is an AI-powered real-time diagnostics and monitoring tool built with Rust and Tauri. It watches log files, Docker containers, and system metrics, detects anomalies, groups them into incidents, and generates AI-driven root-cause analyses with fix suggestions.
## Code style
